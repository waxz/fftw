...
ACLOCAL = ${SHELL} /home/waxz/github/fftw-3.3.7/missing aclocal-1.15
ALLOCA = 
ALTIVEC_CFLAGS = 
AMTAR = $${TAR-tar}
...
AR = ar
AS = as
AUTOCONF = ${SHELL} /home/waxz/github/fftw-3.3.7/missing autoconf
AUTOHEADER = ${SHELL} /home/waxz/github/fftw-3.3.7/missing autoheader
AUTOMAKE = ${SHELL} /home/waxz/github/fftw-3.3.7/missing automake-1.15
AVX2_CFLAGS = 
AVX512_CFLAGS = 
AVX_128_FMA_CFLAGS = 
AVX_CFLAGS = 
...
LT_SYS_LIBRARY_PATH = 
MAINT = #
MAKEINFO = ${SHELL} /home/waxz/github/fftw-3.3.7/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
MPICC = 
MPILIBS = 
...
VERSION = 3.3.7
VSX_CFLAGS = 
abs_builddir = /home/waxz/github/fftw-3.3.7
abs_srcdir = /home/waxz/github/fftw-3.3.7
abs_top_builddir = /home/waxz/github/fftw-3.3.7
abs_top_srcdir = /home/waxz/github/fftw-3.3.7
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
ac_ct_F77 = f77
...
install_sh = ${SHELL} /home/waxz/github/fftw-3.3.7/install-sh
...
8:7:5  $(ENVIRONMENT_LIBFFTW3_LDFLAGS)


# cannot use -no-undefined since dependent on libquadmath
#libfftw3_la_LDFLAGS = -version-info 8:7:5 $(ENVIRONMENT_LIBFFTW3_LDFLAGS)
...
#	current=`echo 8:7:5 | cut -d: -f1`;	\
#	age=`echo 8:7:5 | cut -d: -f3`;		\
#	major=3;						\
